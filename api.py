...
dados = print(f"bem vindo ao mercado livre {nome}! o seu email é {email}, seu telefone {telefone}. Voce mora na rua {dados['logradouro']}, no bairro {dados['bairro']}, na cidade {dados['localidade']} ")
